...
%if %{defined commit}
Source0:        https://github.com/systemd-ci-incubator/systemd%{?stable:-stable}/archive/%{commit}/%{name}-%{shortcommit}.tar.gz
%else
Source0:        https://github.com/systemd-ci-incubator/systemd/archive/v%{github_version}/%{name}-%{github_version}.tar.gz
%endif
